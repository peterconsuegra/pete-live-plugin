...
namespace Pete\PeteLive;

use Illuminate\Support\ServiceProvider;

class PeteLiveServiceProvider extends ServiceProvider
{
    public function register()
    {
        $this->app->bind('pete-live-plugin', function ($app) {
            return new PeteLive;
        });
    }
    ...
    public function boot()
    {
		...
		$this->loadViewsFrom(__DIR__.'/../views','pete-live-plugin');
